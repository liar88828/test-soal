...
import { useAcademicClassStatistic } from "@/lib/swr/use-academic.ts";


export function AcademicClassStatisticCards(props: { idClass: string }) {
	const { data: classData } = useAcademicClassStatistic(props.idClass)
	if (!classData) {
		return null
	}
